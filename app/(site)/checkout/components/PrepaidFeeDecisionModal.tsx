...
export default function PrepaidFeeDecisionModal({
  ...
  return (
    <Modal
      ...
      styles={{
        content: {
          backgroundColor: "var(--v2-bg-surface, #141414)",
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        {/* Message */}
        <p className="text-xs text-[var(--v2-text-secondary,#A0A0A0)] font-medium leading-relaxed mb-6">
          Due to delivery risk indicators on past network activity, a{" "}
          <strong className="text-amber-500 font-bold">Rs. 450 Delivery Fee Prepayment</strong>{" "}
        ...
        <div className="w-full bg-[var(--v2-glass-bg)] border border-[var(--v2-glass-border)] rounded-xl p-3 mb-6 text-left space-y-2">
          <div className="flex items-center gap-2 text-[11px] text-[var(--v2-text-secondary,#A0A0A0)]">
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <button
            type="button"
            onClick={onDismiss}
            className="w-full py-3 px-4 bg-transparent border border-[var(--v2-glass-border)] text-[var(--v2-text-secondary,#A0A0A0)] hover:text-[var(--v2-text-primary,#F5F5F5)] hover:border-[var(--v2-text-secondary)] font-bold uppercase tracking-wider text-[11px] rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer"
          >
            <FiX size={14} />
